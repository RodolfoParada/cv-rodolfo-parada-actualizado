class proyectoIa extends HTMLElement {
   connectedCallback() {
    const proyectos = [
      {
   ...
   this.innerHTML = `
      ...
      <section class="mb-5">
        <h5 class="fw-bold">Proyectos IA : Sistemas con lógica basada en aprendizaje automático, etc.</h5>
      ...
      <link rel="stylesheet" href="css/dark-mode.css"/>
        <div class="card mb-4 p-3 proyecto-card" style="background-color: #95AEE9;">
          <div class="row g-2">
            ...
            <div class="col-md-6">
              <div id="carousel-ia${p.titulo.replace(/\s+/g, '')}" class="carousel slide" data-bs-ride="carousel">
...
customElements.define('proyecto-ia', proyectoIa);
