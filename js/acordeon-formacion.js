class AcordeonFormacion extends HTMLElement {
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-3 fondo-colapse color-fondo">
              <div class="accordion" id="accordionExample">
                ...
                <div class="accordion-item">
                 ...
                 <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed color-fondo" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                 ...
                 <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed color-fondo" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
            ...
            <div class="col-12 col-md-8">
              <div class="accordion-content">
                ...
                <div class="accordion-text" id="accordionTextFour" data-bs-parent="#mainAccordion">
                  <h4 class="fw-bold fs-4 izquierda">${titulo4}</h4>
                  <div class="texto mt-3">${contenido4}</div>
                </div>
                 <div class="accordion-text" id="accordionTextFive" data-bs-parent="#mainAccordion">
  ...
  window.customElements.define("acordeon-formacion", AcordeonFormacion);
