class proyectoFullStack extends HTMLElement {
  connectedCallback() {
    const proyectos = [
      {
        titulo: "Clon Ejemplo Full Stack 1",
      ...
      {
        titulo: "Clon Ejemplo Full Stack 2",
      ...
      {
        titulo: "Clon Ejemplo Full Stack 3",
        ...
        {
        titulo: "Clon Ejemplo Full Stack 4",
        descripcion: "Aplicación que simula la interfaz de Netflix con HTML, CSS y JS.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
      ...
      {
        titulo: "Clon Ejemplo Full Stack 5",
        descripcion: "Interfaz similar a Spotify construida con React.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
      ...
      {
        titulo: "Clon Ejemplo Full Stack 6",
        descripcion: "Simulación de la red social usando Vue.js.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
       ...
       {
        titulo: "Clon Ejemplo Full Stack 7",
        descripcion: "Aplicación que simula la interfaz de Netflix con HTML, CSS y JS.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
      ...
      {
        titulo: "Clon Ejemplo Full Stack 8",
        descripcion: "Interfaz similar a Spotify construida con React.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
      ...
      {
        titulo: "Clon Ejemplo Full Stack 9",
        descripcion: "Simulación de la red social usando Vue.js.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
   ...
   this.innerHTML = `
      ...
      <section class="mb-5">
        <h5 class="fw-bold">Proyectos Full Stack : Aplicaciones que combinan frontend, backend y base de datos.</h5>
