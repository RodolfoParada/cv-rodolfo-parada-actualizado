class proyectoDashboards extends HTMLElement {
  connectedCallback() {
    const proyectos = [
      {
        titulo: "Clon Ejemplo Dashboard 1",
      ...
      {
        titulo: "Clon Ejemplo Dashboard 2",
      ...
      {
        titulo: "Clon Ejemplo Dashboard 3",
        ...
        {
        titulo: "Clon Ejemplo Dashboard 4",
        descripcion: "Aplicación que simula la interfaz de Netflix con HTML, CSS y JS.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
      ...
      {
        titulo: "Clon Ejemplo Dashboard 5",
        descripcion: "Interfaz similar a Spotify construida con React.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
      ...
      {
        titulo: "Clon Ejemplo Dashboard 6",
        descripcion: "Simulación de la red social usando Vue.js.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
       ...
       {
        titulo: "Clon Ejemplo Dashboard 7",
        descripcion: "Aplicación que simula la interfaz de Netflix con HTML, CSS y JS.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
      ...
      {
        titulo: "Clon Ejemplo Dashboard 8",
        descripcion: "Interfaz similar a Spotify construida con React.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
      ...
      {
        titulo: "Clon Ejemplo Dashboard 9",
        descripcion: "Simulación de la red social usando Vue.js.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
   ...
   this.innerHTML = `
      ...
      <section class="mb-5">
        <h5 class="fw-bold">Proyectos Dashboards : Interfaces para monitoreo, visualización de datos y gestión interna, etc.</h5>
      ...
      <link rel="stylesheet" href="css/dark-mode.css"/>
        <div class="card mb-4 p-3 proyecto-card" style="background-color: #95AEE9;">
          <div class="row g-2">
            ...
            <div class="col-md-6">
              <div id="carousel-dashboard${p.titulo.replace(/\s+/g, '')}" class="carousel slide" data-bs-ride="carousel">
...
customElements.define('proyecto-dashboard', proyectoDashboards);
