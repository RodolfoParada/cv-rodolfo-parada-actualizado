   ...
   connectedCallback() {
    const proyectos = [
     ...
     this.innerHTML = `
      ...
      <section class="mb-5">
        <h5 class="fw-bold">Proyectos Juegos y Mini juegos : Proyectos lúdicos hechos con frameworks web o motores de juegos.</h5>
        <div class="col-12">
...
customElements.define('proyecto-juegos', proyectoJuegos);
