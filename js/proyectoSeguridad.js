class proyectoSeguridad extends HTMLElement {
    ...
    const proyectos = [
      {
        titulo: "Clon Ejemplo Seguridad 1",
      ...
      {
        titulo: "Clon Ejemplo Seguridad 2",
      ...
      {
        titulo: "Clon Ejemplo Seguridad 3",
        ...
        {
        titulo: "Clon Ejemplo Seguridad 4",
        descripcion: "Aplicación que simula la interfaz de Netflix con HTML, CSS y JS.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
      ...
      {
        titulo: "Clon Ejemplo Seguridad 5",
        descripcion: "Interfaz similar a Spotify construida con React.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
      ...
      {
        titulo: "Clon Ejemplo Seguridad 6",
        descripcion: "Simulación de la red social usando Vue.js.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
       ...
       {
        titulo: "Clon Ejemplo Seguridad 7",
        descripcion: "Aplicación que simula la interfaz de Netflix con HTML, CSS y JS.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
      ...
      {
        titulo: "Clon Ejemplo Seguridad 8",
        descripcion: "Interfaz similar a Spotify construida con React.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
      ...
      {
        titulo: "Clon Ejemplo Seguridad 9",
        descripcion: "Simulación de la red social usando Vue.js.",
        lenguaje: "HTML, CSS, JS",
        texto:"texto para elementos usados en el proyecto",
        video: "https://tu-video-twitter.com",
   ...
   this.innerHTML = `
      ...
      <section class="mb-5">
        <h5 class="fw-bold">Proyectos de Seguridad : Enfocados en login, manejo de roles, encriptación, etc.</h5>
