class proyectoBackend extends HTMLElement {
   connectedCallback() {
    const proyectos = [
      {
     ...
     this.innerHTML = `
      ...
      <section class="mb-5">
        <h5 class="fw-bold">Proyectos API :  Aplicaciones sin interfaz gráfica que exponen servicios o datos.</h5>
        <div class="col-12">
...
customElements.define('proyecto-backend', proyectoBackend);
